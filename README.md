...
<p align="center">
  <a href="https://github.com/GarrisonFromTheLab/wezterm-config/stargazers">
    <img alt="Stargazers" src="https://img.shields.io/github/stars/GarrisonFromTheLab/wezterm-config?style=for-the-badge&logo=starship&color=C9CBFF&logoColor=D9E0EE&labelColor=302D41">
  </a>
  <a href="https://github.com/GarrisonFromTheLab/wezterm-config/issues">
    <img alt="Issues" src="https://img.shields.io/github/issues/GarrisonFromTheLab/wezterm-config?style=for-the-badge&logo=gitbook&color=B5E8E0&logoColor=D9E0EE&labelColor=302D41">
  </a>
</p>
...
- [**Background Image Selector**](https://github.com/GarrisonFromTheLab/wezterm-config/blob/master/utils/backdrops.lua)
...
- [**GPU Adapter Selector**](https://github.com/GarrisonFromTheLab/wezterm-config/blob/master/utils/gpu_adapter.lua)

  > :bulb: Only works if the [`front_end`](https://github.com/GarrisonFromTheLab/wezterm-config/blob/master/config/appearance.lua#L8) option is set to `WebGpu`.
...
- ##### Steps:
  ...
  1.  ```sh
      ...
      git clone https://github.com/GarrisonFromTheLab/wezterm-config.git ~/.config/wezterm
      ```
  2.  And Done!!! 🎉🎉
